...
const ManageAllOrders = () => {
    ...
    useEffect(() => {
        fetch("https://frightful-alien-95040.herokuapp.com/manageallorders")
            .then((res) => res.json())
    ...
    return (
        <div className="container">
            ...
            {orders?.map((pd) => (
                ...
                <div className="row d-flex justify-content-center mb-2 border border-dark border-5">
                    ...
                    <div className="col-md-2 col-sm-12 border border-info">{pd.service_name}</div>
